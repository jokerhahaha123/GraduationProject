...
java_package_object_mapping, java_object_method_mapping, java_third_party_package_object_mapping_list, java_third_party_object_method_mapping_list = get_necessary_library_information(
    lang, project)
count = 0

for r, ds, files in os.walk(os.path.join(CURRENT_DIR, "SRCML_DATA\\GSON", project)):
    for file in files:
                    ...
                    if tag2 == "function":
                        ...
                        for node2 in block_java_node:
                            ...
                            if tag3 == "name":
                                ...
                                java_decl_stmt_locals = iterate_to_get_node_with_type(java_function_block,
                                                                                      "decl_stmt",
                                ...
                                java_decl_params = iterate_to_get_node_with_type(parameter_list_node, "decl",
                                                                                 java_decl_params)
                                java_param_function_vars_mapping = get_information_of_decl(java_decl_params)
                                java_local_vars_mapping = {**java_local_vars_mapping,
                                                           **java_param_function_vars_mapping}
                                java_local_vars_mapping = {**java_local_vars_mapping, **java_global_vars_mapping}

                                processed_java_code = iterate_function_node_to_get_text("java", block_java_node,
                                                                                        processed_java_code,
                                                                                        java_parent_map,
                                ...
                                if len(splits) > 3:
                                    ...
                                    with open("sentences_gson/java_functions_gson_api_sequences_all_tokens_DATA_1.txt",
                                              "a") as out:
